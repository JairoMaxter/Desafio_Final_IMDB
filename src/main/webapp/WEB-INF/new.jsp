...
<html>
    ...
    <body>
        ...
        <div class="container mt-3">
            ...
            <form:form method="POST" action="/shows/create" modelAttribute="newShow">
                <div class="form-group row pt-2">
                    <form:label path="showTitle" class="col-sm-2 col-form-label col-form-label-sm">Titulo Show: </form:label>
                        <div class="col-sm-10">
